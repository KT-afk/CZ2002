...
public abstract class MenuUI {
    ...
    /**
     * User Interface for Managing Menu Item
     * Invokes corresponding User Interfaces upon selection
     * @param title Title that indicates whether managing individual food dish or set package
     */
    ...
    /**
     * User Interface for selecting which menu item to edit
     * Invokes user interface for editing selected menu item
     */
    ...
    /**
     * User Interface for selecting which menu item to remove
     * Removes menu item upon selection
     */
