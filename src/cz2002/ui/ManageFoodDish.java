...
public class ManageFoodDish extends MenuManager {
    ...
    public ManageFoodDish(Scanner scanner, List<MenuItem> restaurantMenu) {
    ...
    @Override
    void createMenuItem() {
        FoodDish.Type type = FoodDish.Type.MAIN_COURSE;
        String name;
        String description;
        double price;
        ...
        switch (typeSelection) {
            case 1 -> type = FoodDish.Type.MAIN_COURSE;
            case 2 -> type = FoodDish.Type.DRINKS;
            case 3 -> type = FoodDish.Type.DESERT;
        }
